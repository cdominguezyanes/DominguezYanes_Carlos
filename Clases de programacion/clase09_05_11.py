...
# print(nombre_completo.title()) #Aqui usamos tittle para convertir la primera letra de cada palabra en mayuscula, trabajamos con la variable creada anteriormente

# #Ejercicio 4: Pide una frase y una letra. Muestra cuantas veces aparece esa letra en la frase sin distinguir entre mayusculas y minusculas
...
# #Ejercicio 5: Pide una frase y reemplaza las vocales "a" por "@" y muestra el resultado.
# frase=input("Escribe una frase: ")
# frase_formateada=frase.strip().lower() # Lipiamos espacios y convertimos a minusculas
...
# lista2=["tilin", "tilin mayor", "tilin supremo", "tilin multiversal", "tilin dios", 4, 6.6, True] # Lista con diferentes tipos de datos
...
for i in range(11):
    ...
    list3.append(numero) # Agregar un numero ingresado a la lista (append agrega un elemento al final de la lista)
